fp-cli/import-command
=====================

Imports content from a given WXR file.

[![Testing](https://github.com/fp-cli/import-command/actions/workflows/testing.yml/badge.svg)](https://github.com/fp-cli/import-command/actions/workflows/testing.yml)
...
~~~
fp import <file>... --authors=<authors> [--skip=<data-type>]
~~~
...
To install the latest version of this package over what's included in FP-CLI, run:
    ...
    fp package install git@github.com:fp-cli/import-command.git
...
Before you create a new issue, you should [search existing issues](https://github.com/fp-cli/import-command/issues?q=label%3Abug%20) to see if there’s an existing resolution to it, or if it’s already been fixed in a newer version.

Once you’ve done a bit of searching and discovered there isn’t an open or fixed issue for your bug, please [create a new issue](https://github.com/fp-cli/import-command/issues/new). Include as much detail as you can, and clear steps to reproduce if possible. For more guidance, [review our bug report documentation](https://make.wordpress.org/cli/handbook/bug-reports/).

### Creating a pull request

Want to contribute a new feature? Please first [open a new issue](https://github.com/fp-cli/import-command/issues/new) to discuss whether the feature is a good fit for the project.
